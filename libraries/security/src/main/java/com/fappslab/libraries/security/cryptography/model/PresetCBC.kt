...
internal data class PresetCBC(
    @SerializedName("cs")
    override val cipherSpec: TransformationType = TransformationType.CBC,
    @SerializedName("kd")
    override val keyDerivation: DerivationType = DerivationType.PHS256,
    @SerializedName("ka")
